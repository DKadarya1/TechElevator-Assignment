...
public class Exercises {
	...
	public String frontTimes(String str, int n) {
		int frontLength = 3;
        if (frontLength > str.length()) frontLength = str.length();
	...
	public boolean doubleX(String str) {
		...
		int firstXX = str.indexOf("xx");
		int firstX = str.indexOf('x');
		if (firstX != -1 &&firstXX != -1) {
			return firstXX == firstX;
		}
		return false;
	}
	...
	public int last2(String str) {
		  if (str.length() < 2) return 0;
	        ...
	        String done = str.substring(str.length() - 2);
	        int count = 0;

	        for (int i = 0; i < str.length() - 2; i++) {
	            String sub = str.substring(i, i + 2);
	            if (sub.equals(done)) count++;
	        }
	...
	public String altPairs(String str) {
		 String result = "";
	        ...
	        for (int i = 0; i < str.length(); i += 4) {
	            int done = i + 2;
	            if (done > str.length()) done = str.length();
	            result += str.substring(i, done);
	        }
	        return result;
	    }
	/*
