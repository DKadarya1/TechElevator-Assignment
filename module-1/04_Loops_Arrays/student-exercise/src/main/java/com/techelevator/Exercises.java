...
public class Exercises {
	...
	public boolean firstLast6(int[] nums) {
		boolean isFirst6 = nums[0] == 6;
		boolean isLast6 = nums[nums.length - 1] == 6;
		
		boolean isFirstOrLast6 = isFirst6 || isLast6;
	...
	public boolean sameFirstLast(int[] nums) {
		boolean isFirst1 = nums[0] == 6;
		boolean isLast2 = nums[nums.length - 1] == 1;
		
		boolean isFirstOrLast6 = isFirst1 || isLast2;
