...
SELECT name, district, countrycode, population 
FROM city
...
SELECT name, continent, population, GNPold, lifeexpectancy
FROM country
...
SELECT 2017 - indepyear AS number_of_years_since_independance 
FROM country  
